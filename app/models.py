...
# НЕБЕЗПЕКА (навмисна!): Поле password_hash на цьому етапі зберігатиме пароль у відкритому вигляді. Це НЕПРИПУСТИМО в реальних проєктах! У практичній №4 ви заміните це на хешування Argon2/Bcrypt.
